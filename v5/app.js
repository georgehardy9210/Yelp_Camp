...
mongoose.connect("mongodb://localhost/yelp_camp_v4", {useNewUrlParser: true, useCreateIndex: true, useUnifiedTopology: true});
...
app.get("/campgrounds/:id/comments/new", function(request, response){
	...
	Campground.findById(request.params.id, function(err, campground){
		...
		else{ response.render("comments/new", {campground: campground}); }
